      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-100 rounded-2xl overflow-hidden" style={{ height: '500px' }}>
            {/* Google Maps placeholder - In production, you would integrate actual Google Maps */}
            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#5DBB63]/10 to-[#165028]/10">
              <div className="text-center">
                <MapPin className="w-16 h-16 text-[#5DBB63] mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-[#165028] mb-2">Interactive Map</h3>
                <p className="text-gray-600 mb-4">Google Maps integration will be available here</p>
                <div className="flex gap-2 justify-center">
                  {offices.map((office, i) => (
                    <button
                      key={office.city}
                      className="px-4 py-2 bg-white rounded-lg border border-gray-200 hover:border-[#5DBB63] transition-colors"
                    >
                      {office.city}
                    </button>
                  ))}
